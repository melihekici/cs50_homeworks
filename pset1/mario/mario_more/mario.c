...
int main(void)
{
    ...
    for (int i = 1; i <= n; i++)
    {
        ...
        /*Placing one tile of gap between first and second sets of blocks */
        printf("  ");

        /*After placing gap between blocks, now we are going to create second block just like we have created first one */
        for (int j = 1; j <= i; j++)
        {
            printf("#");
        }
